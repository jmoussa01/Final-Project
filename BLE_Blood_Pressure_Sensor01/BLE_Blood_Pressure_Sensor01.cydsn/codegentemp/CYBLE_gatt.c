    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x6Cu] = {
/* Device Name */
(uint8)'B', (uint8)'l', (uint8)'o', (uint8)'o', (uint8)'d', (uint8)' ', (uint8)'P', (uint8)'r', (uint8)'e', (uint8)'s',
(uint8)'s', (uint8)'u', (uint8)'r', (uint8)'e', (uint8)' ', (uint8)'S', (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'o',
(uint8)'r', 
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x2Cu] = {
...
{ 0x0003u, 0x2A00u /* Device Name                         */, 0x00000201u /* rd     */, 0x0003u, {{0x0015u, (void *)&cyBle_attValues[0]}}    },
{ 0x0004u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0005u, {{0x2A01u, NULL}}                           },
{ 0x0005u, 0x2A01u /* Appearance                          */, 0x00000201u /* rd     */, 0x0005u, {{0x0002u, (void *)&cyBle_attValues[21]}}   },
{ 0x0006u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0007u, {{0x2A04u, NULL}}                           },
{ 0x0007u, 0x2A04u /* Peripheral Preferred Connection Par */, 0x00000201u /* rd     */, 0x0007u, {{0x0008u, (void *)&cyBle_attValues[23]}}   },
...
{ 0x000Au, 0x2A05u /* Service Changed                     */, 0x00002201u /* rd,ind */, 0x000Bu, {{0x0004u, (void *)&cyBle_attValues[31]}}   },
{ 0x000Bu, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr  */, 0x000Bu, {{0x0002u, (void *)&cyBle_attValuesCCCD[0]}} },
{ 0x000Cu, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x0014u, {{0x1810u, NULL}}                           },
{ 0x000Du, 0x2803u /* Characteristic                      */, 0x00002001u /* ind    */, 0x000Fu, {{0x2A35u, NULL}}                           },
{ 0x000Eu, 0x2A35u /* Blood Pressure Measurement          */, 0x00002000u /* ind    */, 0x000Fu, {{0x000Du, (void *)&cyBle_attValues[35]}}   },
{ 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesCCCD[2]}} },
{ 0x0010u, 0x2803u /* Characteristic                      */, 0x00001001u /* ntf    */, 0x0012u, {{0x2A36u, NULL}}                           },
{ 0x0011u, 0x2A36u /* Intermediate Cuff Pressure          */, 0x00001000u /* ntf    */, 0x0012u, {{0x000Du, (void *)&cyBle_attValues[48]}}   },
{ 0x0012u, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr  */, 0x0012u, {{0x0002u, (void *)&cyBle_attValuesCCCD[4]}} },
{ 0x0013u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0014u, {{0x2A49u, NULL}}                           },
{ 0x0014u, 0x2A49u /* Blood Pressure Feature              */, 0x00000209u /* rd     */, 0x0014u, {{0x0002u, (void *)&cyBle_attValues[61]}}   },
{ 0x0015u, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x0027u, {{0x180Au, NULL}}                           },
{ 0x0016u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0017u, {{0x2A29u, NULL}}                           },
{ 0x0017u, 0x2A29u /* Manufacturer Name String            */, 0x00000209u /* rd     */, 0x0017u, {{0x0015u, (void *)&cyBle_attValues[63]}}   },
{ 0x0018u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0019u, {{0x2A24u, NULL}}                           },
{ 0x0019u, 0x2A24u /* Model Number String                 */, 0x00000209u /* rd     */, 0x0019u, {{0x0000u, NULL}}                           },
{ 0x001Au, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x001Bu, {{0x2A25u, NULL}}                           },
{ 0x001Bu, 0x2A25u /* Serial Number String                */, 0x00000209u /* rd     */, 0x001Bu, {{0x0000u, NULL}}                           },
{ 0x001Cu, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x001Du, {{0x2A27u, NULL}}                           },
{ 0x001Du, 0x2A27u /* Hardware Revision String            */, 0x00000209u /* rd     */, 0x001Du, {{0x0000u, NULL}}                           },
{ 0x001Eu, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x001Fu, {{0x2A26u, NULL}}                           },
{ 0x001Fu, 0x2A26u /* Firmware Revision String            */, 0x00000209u /* rd     */, 0x001Fu, {{0x0000u, NULL}}                           },
{ 0x0020u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0021u, {{0x2A28u, NULL}}                           },
{ 0x0021u, 0x2A28u /* Software Revision String            */, 0x00000209u /* rd     */, 0x0021u, {{0x0000u, NULL}}                           },
{ 0x0022u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0023u, {{0x2A23u, NULL}}                           },
{ 0x0023u, 0x2A23u /* System ID                           */, 0x00000209u /* rd     */, 0x0023u, {{0x0008u, (void *)&cyBle_attValues[84]}}   },
{ 0x0024u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0025u, {{0x2A2Au, NULL}}                           },
{ 0x0025u, 0x2A2Au /* IEEE 11073-20601 Regulatory Certifi */, 0x00000209u /* rd     */, 0x0025u, {{0x0001u, (void *)&cyBle_attValues[92]}}   },
{ 0x0026u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0027u, {{0x2A50u, NULL}}                           },
{ 0x0027u, 0x2A50u /* PnP ID                              */, 0x00000209u /* rd     */, 0x0027u, {{0x0007u, (void *)&cyBle_attValues[93]}}   },
{ 0x0028u, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x002Cu, {{0x180Fu, NULL}}                           },
{ 0x0029u, 0x2803u /* Characteristic                      */, 0x00001201u /* rd,ntf */, 0x002Cu, {{0x2A19u, NULL}}                           },
{ 0x002Au, 0x2A19u /* Battery Level                       */, 0x00001209u /* rd,ntf */, 0x002Cu, {{0x0001u, (void *)&cyBle_attValues[100]}}  },
{ 0x002Bu, 0x2904u /* Characteristic Presentation Format  */, 0x00000201u /* rd     */, 0x002Bu, {{0x0007u, (void *)&cyBle_attValues[101]}}  },
{ 0x002Cu, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr  */, 0x002Cu, {{0x0002u, (void *)&cyBle_attValuesCCCD[6]}} },
};
